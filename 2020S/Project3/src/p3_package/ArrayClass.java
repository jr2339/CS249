...
public class ArrayClass
{
    ...
    public boolean loadUniqueRandoms(int numRands, int lowLimit, int highLimit)
    {
        ...
        {
            localArray[index] = getRandBetween(lowLimit, highLimit);
        }
        return false;
    }
     ...
     * Exception: Method will not resize capacity below current array size, returns false if this is attempted, true otherwise
    ...
    private void runMerge(int lowIndex, int middleIndex, int highIndex)
    {
        ...
        int startIndex;
        int[] sortedArr = new int[arrayCapacity];
